    ...
    module Tags
      ...
      class NoembedTag < ApplicationTag
        ...
        def initialize(tag_name, markup, options)
          ...
          if match.blank?
            raise ::Liquid::SyntaxError, I18n.t('liquid.errors.syntax.noembed')
          end
        ...
        def build_ruby_request
          ...
          unless res.is_a?(Net::HTTPSuccess)
            return content_tag(:span, I18n.t('liquid.errors.noembed_server'),
                               class: 'status error')
          end
          ...
          if resp.fetch('html', nil).blank?
            ...
            content_tag(:span, message, class: 'status error')
          else
            resp['html']
          end
        end
  ...
  <script type="text/javascript">
    document.addEventListener("DOMContentLoaded", function() {
      ...
      noembedRequest.onerror = function () {
        noembedElement.innerHTML = '<span class="status error">#{I18n.t('liquid.errors.noembed_server')}</span>';
      };
